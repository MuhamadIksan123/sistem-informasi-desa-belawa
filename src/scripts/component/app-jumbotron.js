    ...
    this.innerHTML = `
          ...
          <div class="jumbotron pt-5 mt-5">
            ...
            <div>
                ...
                <p class="jumbotron__subtitle">Nikmati pengalaman membaca dan mempublis karya komik anda, hanya disisi!!!</p>
                <i class="fas fa-book-open" style="font-size:300px;color:white"></i>
            </div>
